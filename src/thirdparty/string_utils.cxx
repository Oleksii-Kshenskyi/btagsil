...
std::string trim_left(std::string&& s) {
    return boost::trim_left(std::move(s));
}

std::string trim_right(std::string&& s) {
    return boost::trim_right(std::move(s));
}

std::string trim(std::string&& s) {
    return boost::trim(std::move(s));
}

std::string lowercase(std::string&& s) {
    return boost::to_lower(std::move(s));
}
...
std::string first_word_of(std::string&& s) {
    ...
    std::erase(std::next(fw_start.begin(), fw_ends), fw_start.end());
    return fw_start;
}

std::string rest(std::string&& s) {
    ...
    std::erase(start_at_second_word.begin(), std::next(start_at_second_word.begin(), sw_starts));
    return start_at_second_word;
}